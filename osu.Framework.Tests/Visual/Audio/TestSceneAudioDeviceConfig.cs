...
{
    public partial class TestSceneAudioDeviceConfig : FrameworkTestScene
    {
        ...
        public TestSceneAudioDeviceConfig()
        {
        ...
        protected override void LoadComplete()
        {
            ...
            // When user selects from dropdown, convert display value to actual value
        ...
        private string getStatusText()
        {
            ...
            return $"Backend: {(audioManager.UseExperimentalWasapi.Value ? "WASAPI" : "DirectSound")} | Device: {currentDevice} | Sample: {isPlaying} | Track: {isTrackPlaying}";
        }
